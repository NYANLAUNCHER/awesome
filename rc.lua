...
--mygotomenu = awful.widget.launcher({ image = beautiful.awesome_icon,
--                                     menu = mygotomenu })

-- Menu for window layouts
--mylayoutmenu = awful.widget.launcher({ image = beautiful.awesome_icon,
--                                       menu = mylayoutmenu })
...
gears.timer {
  ...
  autostart = true,
  callback = function()
    --naughty.notify({text="Look at something 20 feet away.", timeout=8, height=beautiful.notification_height + 20, width=beautiful.notification_width - 40})
    naughty.notify({preset = naughty.config.presets.critical,
    text="Look at something 20 feet away.", timeout=8, height=40*1.2, width=100*2})
  end
}
...
-- Autostart Apps
-- source = "https://awesomewm.org/doc/api/libraries/awful.spawn.html#once"
...
for _, app in ipairs(run_on_startup) do
